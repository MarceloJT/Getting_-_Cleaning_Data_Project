...
The compressed file with all data sets was unzipped in a local directory of my computer, that can be found at the "source" command of "run_analysis.R" file.
